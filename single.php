...
<div id="picture-frame">
			<img src="images/of9.png" data-src="images/onions.png" alt="" class="img-responsive"/>
		</div>
		...
		<script>
			...
			<div class="col-md-7 single-top-left ">
				...
				<h3>Onions</h3>
				 ...
				 <div class="pr-single">
				  <p class="reduced "><del>Rs 35.00</del>Rs 29.00</p>
				</div>
				<div class="block block-w3">
					<div class="starbox small ghosting"> </div>
				</div>
				<p class="in-pa"> A fresh onions direct from farms  </p>
